...
set.seed(20230707) # fix seed for simulations (20200315 replicates the paper's results)
n_sim <- 5000# number of simulations (5000 was used in paper,# be aware that this code is memory intensive and might freeze your computer. 
# Increase n_sim at your own risk!!
n_days_ahead <- 25*365 # Number of days ahead to simulate (10*365 in paper)
